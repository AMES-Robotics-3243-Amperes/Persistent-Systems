...
public class RobotContainer {
  ...
  private void configureBindings() {
    ...
    SplineSegmentFactory segment2 = new C2HermiteSegmentFactory(new Translation2d(-1, 0.25),
      new Translation2d(-1, -1));
    SplineSegmentFactory segment3 = new C2HermiteSegmentFactory(new Translation2d(-2.2, -0.25),
      new Translation2d(-0.5, 1.2));
    SplineSegmentFactory segment4 = new C2HermiteSegmentFactory(new Translation2d(-2.5, 0.5), 
    ...
    CommandSwerveFollowSpline splineCommand = new CommandSwerveFollowSpline(subsystemSwerveDrivetrain,
      spline, 10.0, xController, yController);
